package xianzhan.jvmjava.java.interpret;

import org.junit.jupiter.api.Test;
import xianzhan.jvmjava.java.classfile.ClassFile;
import xianzhan.jvmjava.java.classfile.ClassReader;
...
public class InterpreterTest {
    ...
    public void testInterpret() throws IOException {
        String file = "src/test/resources/xianzhan/jvmjava/java/interpret/OneToHundred.class";
